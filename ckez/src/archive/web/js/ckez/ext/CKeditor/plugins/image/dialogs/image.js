                        ...
                        children: [{
                            ...
                            onChange: function() {
                                ...
                                if (0 < b.length) {
                                    ...
                                    d.on("error", h, a);
                                    d.on("abort", h, a);
                                    if (b.indexOf("-portlet") > -1) {
                                    	var app = b.split("/")[1];
                                        console.log("app: " + app);
                                        b = b.replace("/" + app, "");
                                        console.log("newUrl: " + b);
                                    }
                                    console.log("b: " + b);
                            ...
                            commit: function(a, b) {
                            	console.log("COMMIT: " + this.getValue());
                                ...
                                a == f && (newUrl || this.isChanged()) ? (b.data("cke-saved-src", newUrl),
                                    b.setAttribute("src", newUrl)) : 8 == a && (b.setAttribute("src", ""), b.removeAttribute("src"))
                            },
